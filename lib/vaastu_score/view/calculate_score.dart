...
implements CommonInterface{
  ...
  Widget body() {
    return SingleChildScrollView(
            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  SizedBox(height:10),    
                  Text("ROOM-WISE BREAKUP OF VAASTU SCORE",
                  style: TextStyle(
                    color: ColorUtils.color_labels,
                    fontWeight: FontWeight.bold,
                    fontSize: 14,
                  ...
                  CustomTextField(
                                        isVisible: true,
                                        text: "Tap on any room name to know more about the details of the room.",
                                        colors: ColorUtils.color_labels,
              ...
              SizedBox(height:20),
               CustomButton(text: "RESET VAASTU SCORE", isValidated: true,
      ...
      SizedBox(height:20),    
      Image(image: AssetImage(ASSETUTILS.ASSETS_SCORE_BOTTOM),)
            ],
          ),
      ),
    );
  ...
  getResponse(selectedRoom).then((value) {
    setState(() {
      ...
      vaastuScoreStatus = calculateVaastuScore.payload.data.vastuScoreStatus;
      roomWiseVastuScore= calculateVaastuScore.payload.data.roomWiseVastuScore;
              ...
              ListTile(
                onTap: (){
                  Navigator.of(context).push(
                    ...
                    (context)=>RoomDetailsScreen(title: roomWiseVastuScore[index].room))
                  );
                },
                trailing: Container(
                  width: 120,
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.all(Radius.circular(10)),
                    color: roomWiseVastuScore[index].legend.toUpperCase().trim().toUpperCase()=='Favorable'.toUpperCase()
                  ?ColorUtils.color_favourate_bg
                  :roomWiseVastuScore[index].legend.toUpperCase()=="NEUTRAL"
                  ?ColorUtils.color_netural_bg
                  :roomWiseVastuScore[index].legend.toUpperCase()=="UNFAVOURABLE"
                  ?ColorUtils.color_unfavourate_bg
                  :ColorUtils.color_white
                  ),
                
                  child: Center(
                    child: Text(roomWiseVastuScore[index].legend.toUpperCase(),
                                   style: TextStyle(
                                     color: ((roomWiseVastuScore[index].legend.trim().toString().toUpperCase()=='Favorable'.toString().toUpperCase())
    ? ColorUtils.color_favourate
        : roomWiseVastuScore[index].legend.trim().toString().toUpperCase()=='NEUTRAL'
    ?ColorUtils.color_netural
        : roomWiseVastuScore[index].legend.trim().toString().toUpperCase()=='UNFAVOURABLE'
        ...
        :ColorUtils.color_red),
                ...
                subtitle: Text("( ${roomWiseVastuScore[index].direction} )"),
                ),
              ...
              child: Column(
                ...
                children: <Widget>[
                      ...
                      child: Column(
                        ...
                        children: [
                          CustomTextField(
                                          ...
                                          CustomTextField(
                                            isVisible: true,
                                            text: "Here is what diffent Compliant score mens!",
                                            colors: ColorUtils.color_labels,
                                            fontWeight: FontWeight.w400,
                                            size: 14,
                                            isBold: false,
                  ...
                  style: TextStyle(
                    ...
                    CustomTextField(
                                            isVisible: true,
                                            text: "Your plan as per hight stander of vaastu.Good Job!",
                                            colors: ColorUtils.color_labels,
                                            fontWeight: FontWeight.w400,
                                            size: 14,
                                            isBold: false,
                  ...
                  style: TextStyle(
                    ...
                    CustomTextField(
                                            isVisible: true,
                                            text: "Most of the room in your layout have porper vaastu compilance",
                                            colors: ColorUtils.color_labels,
                                            fontWeight: FontWeight.w400,
                                            size: 14,
                                            isBold: false,
                                          ...
                                          SizedBox(height:20),
                                           Text("Improvment required".toUpperCase(),
                  style: TextStyle(
                    color: ColorUtils.color_vaastu_score_label,
                    fontWeight: FontWeight.bold,
                    fontSize: 12,
                    ...
                    CustomTextField(
                                            isVisible: true,
                                            text: "If you are in planning stage, try repositionig some rooms to improve vaastu compilance",
                                            colors: ColorUtils.color_labels,
                                            fontWeight: FontWeight.w400,
                                            size: 14,
                                            isBold: false,
                                          ...
                                          SizedBox(height:20),
                                           Text("Non-vaastu compliant".toUpperCase(),
                  style: TextStyle(
                    color: ColorUtils.color_vaastu_score_label,
                    fontWeight: FontWeight.bold,
                    fontSize: 12,
                    ...
                    CustomTextField(
                                            isVisible: true,
                                            text: "Please consult a vaastu expert to help design the layout accroding to vaastu ",
                                            colors: ColorUtils.color_labels,
                                            fontWeight: FontWeight.w400,
                                            size: 14,
                                            isBold: false,

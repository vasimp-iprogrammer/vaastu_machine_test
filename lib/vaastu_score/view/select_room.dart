            ...
            Padding(
              ...
              child: Align(
                ...
                child: CustomTextField(
                  isVisible: true,
                  text:
                      "Select multiple room that are present in this direction: ",
                  colors: ColorUtils.color_labels,
                  fontWeight: FontWeight.w400,
                  size: 14,
                  isBold: false,
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return Column(
          children: [
            CheckboxListTile(
              value: prevSelectedRoomList.contains(roomList[index])
                  ? true
                  : _isChecked[index],
              title: Text(
                roomList[index],
                  ...
                  () {
                    ...
                    if (val == true) {
                      if (roomList.length > 0 &&
                          !selectedRoomList.contains(roomList[index]))

          ...
          children: [
              ...
              children: [
                Expanded(
                  child: CustomTextField(
                    isVisible: true,
                    text: "None",
                    colors: ColorUtils.color_calcul_score,
                    fontWeight: FontWeight.bold,
                    size: 14,
                    isBold: true,
                  ),
            ...
            Center(
              child: Column(
                children: [
                  ClipRRect(
                    child: Image.asset(ASSETUTILS.ASSETS_COMPASS_LOC,
                        fit: BoxFit.contain),
                  ),
                  SizedBox(height: 5),
                  ClipRRect(
                    child: Image.asset(ASSETUTILS.ASSETS_COMPASS_ARROW,
                        fit: BoxFit.contain),
                  ),
                  ClipRRect(
                    child: Image.asset(ASSETUTILS.ASSETS_COMPASS,
                        fit: BoxFit.contain),
                  ),
                ],
              ),
            ...
            CustomTextField(isVisible: true,
             text: "Select a room from top right to check its compliant direction.", 
             isBold: false, 
             size: 11,
